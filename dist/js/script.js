...
/* harmony import */ var _modules_showingLoginPopup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/showingLoginPopup */ "./src/js/modules/showingLoginPopup.js");
...
/* harmony import */ var _modules_sendForm__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/sendForm */ "./src/js/modules/sendForm.js");
/* harmony import */ var _modules_showMore__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/showMore */ "./src/js/modules/showMore.js");
/* harmony import */ var _modules_maskPhoneNumber__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/maskPhoneNumber */ "./src/js/modules/maskPhoneNumber.js");
/* harmony import */ var _modules_maskMail__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/maskMail */ "./src/js/modules/maskMail.js");
/* harmony import */ var _modules_smoothScroll__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/smoothScroll */ "./src/js/modules/smoothScroll.js");
...
document.addEventListener('DOMContentLoaded', function () {
  Object(_modules_showingLoginPopup__WEBPACK_IMPORTED_MODULE_0__["default"])('#login-icon', '.popup-header');
  ...
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])('[data-login]', '[data-modal]', '.overflowing');
  ...
  Object(_modules_sendForm__WEBPACK_IMPORTED_MODULE_5__["default"])('.feed-form', '[data-modal-thanks]', '.overflowing');
  Object(_modules_showMore__WEBPACK_IMPORTED_MODULE_6__["default"])('.sale__slider-mobile-btn', '.sale__slider-item', 4);
  Object(_modules_maskPhoneNumber__WEBPACK_IMPORTED_MODULE_7__["default"])('[name="phone"]');
  Object(_modules_maskMail__WEBPACK_IMPORTED_MODULE_8__["default"])('[name="email"]');
  Object(_modules_smoothScroll__WEBPACK_IMPORTED_MODULE_9__["default"])('#goHome', 0.25);
});
...
var accordion = function accordion(_ref) {
  var triggerElem = _ref.triggerElem,
    spanClass = _ref.spanClass,
    spanActiveClass = _ref.spanActiveClass,
    questionActiveClass = _ref.questionActiveClass,
    answerActiveClass = _ref.answerActiveClass;
  var triggers = document.querySelectorAll(triggerElem);
  triggers.forEach(function (trigger) {
    trigger.addEventListener('click', function () {
      var span = trigger.querySelectorAll(spanClass);
      span.forEach(function (item) {
        return item.classList.toggle(spanActiveClass);
      });
...
var burgerMenu = function burgerMenu(_ref) {
  var burgerSelector = _ref.burgerSelector,
    menuSelector = _ref.menuSelector,
    titleSelector = _ref.titleSelector,
    burgerActiveClass = _ref.burgerActiveClass,
    menuActiveClass = _ref.menuActiveClass,
    titleActiveClass = _ref.titleActiveClass;
  var burger = document.querySelector(burgerSelector);
  var burgerMenu = document.querySelector(menuSelector);
...
var maskMail = function maskMail(mailSelector) {
  var mailInputs = document.querySelectorAll(mailSelector);
...
/* harmony default export */ __webpack_exports__["default"] = (maskMail);

/***/ }),

/***/ "./src/js/modules/maskPhoneNumber.js":
/*!*******************************************!*\
  !*** ./src/js/modules/maskPhoneNumber.js ***!
  \*******************************************/
/*! exports provided: default */
...
var maskPhoneNumber = function maskPhoneNumber(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (maskPhoneNumber);
...
var modal = function modal(triggers, modalSelector, overflowSelector) {
  var modalOpenedBtns = document.querySelectorAll(triggers);
  var modal = document.querySelector(modalSelector);
  var overflow = document.querySelector(overflowSelector);
  ...
  modalOpenedBtns.forEach(function (btn) {
...
var sendForm = function sendForm(formSelector, modalSelector, overflowSelector) {
...
var showMore = function showMore(trigger, contentSelector, offsetNum) {
  var triggerBtn = document.querySelector(trigger);
  var showedContent = document.querySelectorAll(contentSelector);
  var showIndex = 0;
  var offset = offsetNum;
  if (document.documentElement.clientWidth <= 414) {
    showedContent.forEach(function (item) {
      item.classList.add('hide');
    });
    var shovingFourItemsContent = function shovingFourItemsContent(x) {
      if (showIndex >= showedContent.length - offset) {
        triggerBtn.remove();
        for (var i = showIndex; i < showedContent.length; i++) {
          showedContent[i].classList.remove('hide');
        }
      } else {
        for (var _i = x; _i < x + offset; _i++) {
          showedContent[_i].classList.remove('hide');
        }
        showIndex = x + offset;
        return showIndex;
      }
...
/***/ "./src/js/modules/showingLoginPopup.js":
/*!*********************************************!*\
  !*** ./src/js/modules/showingLoginPopup.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var showingLoginPopup = function showingLoginPopup(trigger, loginPopupSelector) {
  var loginIcon = document.querySelector(trigger);
  var loginPopup = document.querySelector(loginPopupSelector);
  ...
  var hideLoginPopup = function hideLoginPopup() {
...
/* harmony default export */ __webpack_exports__["default"] = (showingLoginPopup);
...
var slider = function slider(_ref) {
  var container = _ref.container,
    ...
    adaptiveSlideCounter920 = _ref.adaptiveSlideCounter920;
  if (document.documentElement.clientWidth <= 414) {
    return;
  } else {
    var deleteNotANunber = function deleteNotANunber(str) {
      return +str.replace(/\D/g, '');
    };
    var _slider = document.querySelector(container);
    var slides = document.querySelectorAll(slidesSelector);
    var oneSlide = document.querySelector(slidesSelector);
    var next = document.querySelector(nextBtn);
    var slidesWrapper = document.querySelector(wrapper);
    var slidesField = document.querySelector(inner);
    var widthOneSlide = window.getComputedStyle(oneSlide).width;
    var marginRight = window.getComputedStyle(oneSlide).marginRight;
    ...
    slidesField.style.width = 100 * _slider.length + '%';
    ...
    var counter = Math.round(slides.length / slideCount);
    next.addEventListener('click', function () {
      var num = slideCount * deleteNotANunber(widthOneSlide) + deleteNotANunber(marginRight) * slideCount;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var smoothScroll = function smoothScroll(trigger, speedNum) {
  var triggerBtn = document.querySelector(trigger);
  var speed = speedNum;
  triggerBtn.addEventListener('click', function (event) {
    ...
    var hash = this.hash;
    var target = document.querySelector(hash).getBoundingClientRect().top;
    var start = null;
    var frame = function frame(time) {
      ...
      var r = target < 0 ? Math.max(widthTop - progress / speed, widthTop + target) : Math.min(widthTop + progress / speed, widthTop + target);
